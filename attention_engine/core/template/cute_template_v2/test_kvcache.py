...
def main():
    ...
    cache_seqlens_small = torch.tensor(
        context_seqlens[1:] + [0] * num_padding_queries,
        dtype=torch.int32,
        device="cuda",
    )
    ...
    time_fa3_big = benchmark_fa_kv(
        fa3.flash_attn_with_kvcache,
    ...
    time_fa3_small = benchmark_fa_kv(
        fa3.flash_attn_with_kvcache,
        repeats=args.repeats,
        q=q_buf_small,
        k_cache=k_cache,
    ...
    time_fa2_big = benchmark_fa_kv(
        fa2.flash_attn_with_kvcache,
        repeats=args.repeats,
        q=q_buf_large,
        k_cache=k_cache,
        v_cache=v_cache,
    ...
    time_fa2_small = benchmark_fa_kv(
        fa2.flash_attn_with_kvcache,
        repeats=args.repeats,
        q=q_buf_small,
        k_cache=k_cache,
