...
from .results import load_csv_data

colormap = plt.cm.Set2  # LinearSegmentedColormap


def plot_figure11(
    results_dir: str | Path, output_path: str | Path = "figure11_h100.pdf"
):
